...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common_send_options(command_parser: argparse.ArgumentParser) -> None:
        command_parser.add_argument("--pair", default="jeeves", help="Pair id to address.")
    ...
    status_parser.add_argument("--pair", default="jeeves", help="Pair id to read.")
    ...
    companion_parser.add_argument("--pair", default="jeeves", help="Pair id to read.")
    ...
    set_companion.add_argument("--pair", default="jeeves", help="Pair id to update.")
    ...
    history_parser.add_argument("--pair", default="jeeves", help="Pair id to read.")
    ...
    status_health_parser.add_argument("--pair", default="jeeves", help="Pair id to read.")
    ...
    healthz_parser.add_argument("--pair", default="jeeves", help="Pair id to read.")
    ...
    ask.add_argument("--pair", default="jeeves", help="Pair id to address.")
    ...
    watch_parser.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    watch_parser.set_defaults(func=watch)

    touch_lamp = subcommands.add_parser("watch-touch-lamp", help="Turn LEDs green while StackChan head touch is held.")
    touch_lamp.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    touch_emotions.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    sensors.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    serve_audio_parser.add_argument("--pair", default="jeeves", help="Pair id to serve.")
    ...
    power.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    add_reminder_parser.add_argument("--pair", default="jeeves", help="Pair id to notify.")
    ...
    reminders.add_argument("--pair", default="jeeves", help="Pair id to notify.")
    ...
    settings.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    info_mode.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    idle_sleep.add_argument("--pair", default="jeeves", help="Pair id to watch.")
    ...
    life.add_argument("--pair", default="jeeves", help="Pair id to animate.")
    ...
    run.add_argument("--pair", default="jeeves", help="Pair id to serve.")
